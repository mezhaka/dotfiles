...
Full directive text, BAD/GOOD example pairs, and rationale per rule live in `~/.claude/.agent-style/RULES.md` (pinned canonical source: https://raw.githubusercontent.com/yzhao062/agent-style/v0.4.2/RULES.md). The compact directives above are enough for drafting. Read the full file, or the sections for the rules in question, when polishing a longer document, when a directive above is ambiguous for the sentence at hand, or when the user asks why a rule applies.
<!-- owned-by: agent-style; version: v0.4.2; sha256: 530b895fa6db58de71621c8af89ec2a724d70eb823ada5b5b6b7366038c53252 -->
